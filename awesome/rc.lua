...
beautiful.init(themes_dir .. "/powerarrowf/theme.lua")
...
mymainmenu = awful.menu({ items = { { "Arch Linux", myawesomemenu, beautiful.awesome_icon },
--{ "terminal", terminal },
-- { "firefox", browser },
...
-- wireless widget 
net_wireless = net_widgets.wireless({interface="wlp6s0"})
...
'<span background="#D0785D" font="Inconsolata 11"> <span font="Inconsolata 11" color="#EEEEEE">ums</span></span>', 
800)
...
'<span background="#4B3B51" font="Inconsolata 11"><span font="Inconsolata 11" color="#EEEEEE"> Vol:$1 </span></span>', 0.1, "Master")
...
--backlight
    awful.key({ }, "XF86MonBrightnessDown", function ()
        awful.util.spawn("xbacklight -dec 1",false) end),
    awful.key({ }, "XF86MonBrightnessUp", function ()
        awful.util.spawn("xbacklight -inc 1",false) end),
